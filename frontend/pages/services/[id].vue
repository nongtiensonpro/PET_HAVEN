          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <p class="mb-1"><small class="text-muted">{{ t('name') }}: {{
                    danhGia.idhoadon.idlichhen.thucung.ten
                  }}</small></p>
                <p class="mb-1"><small class="text-muted">{{ t('breed') }}: {{
                    danhGia.idhoadon.idlichhen.thucung.giong
                  }}</small>
                </p>
